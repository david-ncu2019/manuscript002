...
def main():
    # Setup paths
    data_dir = r"D:\1000_SCRIPTS\004_Project003\20260427_InSAR_MLCW_v2\GPS_timeseries\patch_3"
    output_dir = r"D:\1000_SCRIPTS\004_Project003\20260427_InSAR_MLCW_v2\GPS_decomposition"

    # Find all CSV files ending with _neu.csv in the directory
    csv_files = sorted(glob.glob(os.path.join(data_dir, "*_neu.csv")))
    ...
    for i, csv_file in enumerate(csv_files, 1):
        station_name = Path(csv_file).stem.replace('_neu', '')
