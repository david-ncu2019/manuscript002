...
To prepare the model inputs, the observations described in \Cref{subsec:datasets} were converted to a common monthly scale. A deformation time series model aligned the MLCW and cGNSS displacement records collected on different dates and produced monthly increments. The MLCW increments formed the response, while cGNSS increments, section-specific hydraulic head changes, and seasonal terms formed the predictors.
