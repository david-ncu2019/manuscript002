...
% my raw idea
the GWR was applied under the assumption that:
- instantaneous response of MLCW compaction when total displacement change
- the change of layerwise compaction have a linear relationship with change of total surface deformation
