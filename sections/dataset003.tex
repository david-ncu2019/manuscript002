...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}p{0.15\textwidth}>{\centering\arraybackslash}p{0.11\textwidth}>{\centering\arraybackslash}p{0.11\textwidth}>{\raggedright\arraybackslash}p{0.12\textwidth}>{\raggedright\arraybackslash}p{0.15\textwidth}@{}}
    \toprule
    \textbf{Dataset} & \textbf{Station or profile} & \textbf{Longitude ($^\circ$E)} & \textbf{Latitude ($^\circ$N)} & \textbf{Sampling interval} & \textbf{Observation period} \\
    \midrule
    MLCW compaction & Tuku MLCW, 0--300~m & 120.390 & 23.688 & Monthly & 01/2010--12/2024 \\
    Groundwater level & Tuku wells, Aquifers 1--4 & 120.390 & 23.688 & Daily & 01/2008--12/2024 \\
    cGNSS displacement & TKJS & 120.390 & 23.688 & Daily & 01/2010--12/2024 \\
    Borehole lithology & Tuku borehole, 0--300~m & 120.390 & 23.688 & Static & -- \\
    \bottomrule
  \end{tabularx}
\end{table}
