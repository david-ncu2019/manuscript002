...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{@{}p{0.21\textwidth}p{0.27\textwidth}X@{}}
    ...
    Hydraulic head in the target section & Current and lagged hydraulic head changes, target section & Hydraulic conditions in the section being estimated \\
    Hydraulic head in other sections & Current and lagged hydraulic head changes, other five sections & Hydraulic conditions in the other monitored depths \\
